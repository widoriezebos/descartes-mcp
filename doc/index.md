# Descartes MCP Documentation

Use this index to navigate the Descartes MCP documentation set.

- [Architecture](architecture.md) — runtime model, extension points, and deployment considerations.
- [Runtime Debugger](debugger.md) — JShell, sessions, object inspection, and exception tooling.
- [Log Analysis](logging.md) — comprehensive log search, extraction, timeline analysis, and multi-file operations.
- [Profiler](profiler.md) — JFR-based workflows, profile types, exports, and retention.
...
- [Debug Skill Setup](debug-skill.md) — one canonical `.agents/skills/descartes-debug` workflow across Claude Code, Codex, and Gemini CLI.

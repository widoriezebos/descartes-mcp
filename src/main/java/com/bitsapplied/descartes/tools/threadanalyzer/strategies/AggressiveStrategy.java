...
/**
 * Strategy for very large thread counts (>100 threads) with aggressive
 * filtering.
 *
 * <p>
 * This strategy:
 ...
 *
 * <p>
 * With >100 threads, users should typically use thread_search instead, but this
 * strategy provides a reasonable fallback.
 *
 * @since 0.0.1
 */

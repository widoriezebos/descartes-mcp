...
/**
 * Controls the level of detail included in thread dumps based on available size budget.
 *
 * <p>As the size budget depletes, this controller progressively reduces the amount of detail
 * included for each thread, ensuring that at least summary information is included for
...
public class DetailLevelController {
    ...
    /**
     * Records that detail level was reduced.

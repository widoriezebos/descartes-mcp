...
/**
 * Strategy interface for thread dump generation with different filtering
 * approaches.
 *
 * <p>
 * Implementations decide how to filter and prioritize threads when generating
...
public interface ThreadDumpStrategy {
   ...
   *
   * @return Minimum score threshold (-100 to include all, 0 to exclude negative
   *         scores, etc.)
   */
  int getMinimumScore();

...
Compatibility entry point for Claude-based tooling.
...
- `doc/debug-skill.md` — single-source `.agents/skills/descartes-debug` setup across Claude Code, Codex, and Gemini CLI.
